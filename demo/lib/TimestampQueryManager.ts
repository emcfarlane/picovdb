// https://webgpu.github.io/webgpu-samples/?sample=timestampQuery#PerfCounter.ts
// https://webgpu.github.io/webgpu-samples/?sample=timestampQuery#TimestampQueryManager.ts
...
export class TimestampQueryManager {
  ...
  resolve(commandEncoder: GPUCommandEncoder) {
    ...
    if (this.#timestampMapBuffer.mapState === 'unmapped') {
      ...
      // Safari is strict about the function signature, so use the long form:
      ...
      commandEncoder.copyBufferToBuffer(
        ...
        this.#timestampBuffer.size // size
      );
    }
  }
